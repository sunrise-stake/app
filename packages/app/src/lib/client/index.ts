...
export class SunriseStakeClient {
  ...
  async createGSolTokenAccount (): Promise<string> {
    if ((this.stakerGSolTokenAccount == null) || (this.config == null)) throw new Error('init not called')
  ...
  private async createMSolTokenAccount (
    ...
    if ((this.marinadeState == null) || (this.marinade == null) || (this.config == null)) throw new Error('init not called')
    ...
    return await this.provider.sendAndConfirm(createAccountsTransaction, [])
  }

  public async deposit (amount: BN): Promise<string> {
    if ((this.marinadeState == null) || (this.marinade == null) || (this.config == null) || (this.stakerGSolTokenAccount == null)) throw new Error('init not called')
  ...
  public async details (): Promise<Details> {
    if ((this.marinadeState == null) || (this.stakerGSolTokenAccount == null) || (this.config == null)) throw new Error('init not called')
