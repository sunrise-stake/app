...
exports.MINIMUM_EXTRACTABLE_YIELD =
  exports.NETWORK_FEE =
  exports.MARINADE_TICKET_RENT =
  exports.DEFAULT_LP_MIN_PROPORTION =
  exports.DEFAULT_LP_PROPORTION =
  exports.HOLDING_ACCOUNT =
  exports.SUNRISE_STAKE_STATE =
  exports.SOLBLAZE_CONFIG =
...
exports.STAKE_POOL_PROGRAM_ID = new web3_js_1.PublicKey(
  "SPoo1Ku8WFXoNDMHPsrGSTSG1Y47rzgn41SLUNakuHy"
);
exports.Environment = {
  "mainnet-beta": {
    state: new web3_js_1.PublicKey(
      "43m66crxGfXSJpmx5wXRoFuHubhHA1GCvtHgmHW6cM1P"
    ),
    holdingAccount: new web3_js_1.PublicKey(
      "shcFT8Ur2mzpX61uWQRL9KyERZp4w2ehDEvA7iaAthn"
    ),
  },
  testnet: {
    state: new web3_js_1.PublicKey(
      "DR3hrjH6SZefraRu8vaQfEhG5e6E25ZwccakQxWRePkC"
    ),
    holdingAccount: new web3_js_1.PublicKey(
  ...
  devnet: {
    state: new web3_js_1.PublicKey(
      "Jpp29FzyV7rXdVRWFaiE9tBcVCaEMvj16gk87rC3S4z"
    ),
    holdingAccount: new web3_js_1.PublicKey(
      "dhcB568T3skiP2D9ujf4eAJEnW2gACaaA9BUCVbwbXD"
    ),
...
exports.SolBlazeEnvironment = {
  "mainnet-beta": {
    pool: new web3_js_1.PublicKey(
      "stk9ApL5HeVAwPLr3TLhDXdZS8ptVu7zp6ov8HFDuMi"
    ),
    bsolMint: new web3_js_1.PublicKey(
