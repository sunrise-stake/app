...
exports.marinadeTargetReached =
  exports.getValidatorIndex =
  exports.getVoterAddress =
  exports.getStakeAccountInfo =
  exports.proportionalBN =
  ...
  exports.confirm =
  exports.logKeys =
  exports.findOrderUnstakeTicketAccount =
  exports.findOrderUnstakeTicketManagementAccount =
  exports.findGSolMintAuthority =
  exports.findBSolTokenAccountAuthority =
  exports.findMSolTokenAccountAuthority =
  exports.ZERO =
    void 0;
...
const findMSolTokenAccountAuthority = (config) =>
  findProgramDerivedAddress(config, "msol_account" /* M_SOL_ACCOUNT */);
exports.findMSolTokenAccountAuthority = findMSolTokenAccountAuthority;
const findBSolTokenAccountAuthority = (config) =>
  findProgramDerivedAddress(config, "bsol_account" /* B_SOL_ACCOUNT */);
exports.findBSolTokenAccountAuthority = findBSolTokenAccountAuthority;
const findGSolMintAuthority = (config) =>
  findProgramDerivedAddress(
    config,
    "gsol_mint_authority" /* G_SOL_MINT_AUTHORITY */
  );
...
const findOrderUnstakeTicketManagementAccount = (config, epoch) => {
  ...
  return findProgramDerivedAddress(
    config,
    "order_unstake_ticket_mgmt" /* ORDER_UNSTAKE_TICKET_MANAGEMENT_ACCOUNT */,
    [epochBuf]
  );
};
exports.findOrderUnstakeTicketManagementAccount =
...
const confirm = (connection) => (txSig) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return connection.confirmTransaction(
      Object.assign({ signature: txSig }, yield connection.getLatestBlockhash())
    );
  });
...
const findAllTickets = (connection, config, managementAccount, epoch) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = managementAccount.tickets.toNumber(); i >= 0; i--) {
      const [orderUnstakeTicketAccount] = (0,
      exports.findOrderUnstakeTicketAccount)(config, epoch, BigInt(i));
    ...
    return accountInfos
      .map((accountInfo, i) => [tickets[i], accountInfo])
...
const getStakeAccountInfo = (
  stakeAccount,
  anchorProvider
  // program: anchor.Program<SunriseStake>,
) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const provider = new marinade_ts_sdk_1.Provider(
      anchorProvider.connection,
      anchorProvider.wallet,
      {}
    );
    const parsedData =
      marinade_ts_sdk_1.MarinadeUtils.getParsedStakeAccountInfo(
        provider,
        stakeAccount
      );
...
const getValidatorIndex = (marinadeState, voterAddress) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const marinadeTargetReached = (details, percentage) => {
  ...
  const limit = (0, exports.proportionalBN)(
    gsolSupply,
    new anchor_1.BN(percentage),
    new anchor_1.BN(100)
  );
