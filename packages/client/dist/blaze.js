...
exports.blazeWithdrawStake = exports.blazeWithdrawSol = exports.blazeDepositStake = exports.blazeDeposit = void 0;
...
const blazeDeposit = (config, program, blaze, depositor, depositorGsolTokenAccount, lamports) => __awaiter(void 0, void 0, void 0, function* () {
    const [gsolMintAuthority] = (0, util_1.findGSolMintAuthority)(config);
    const bsolTokenAccountAuthority = (0, util_1.findBSolTokenAccountAuthority)(config)[0];
    const bsolAssociatedTokenAddress = yield anchor_1.utils.token.associatedAddress({
        mint: blaze.bsolMint,
...
const blazeDepositStake = (config, program, provider, blaze, depositor, stakeAccount, depositorGsolTokenAccount) => __awaiter(void 0, void 0, void 0, function* () {
    const [gsolMintAuthority] = (0, util_1.findGSolMintAuthority)(config);
    const bsolTokenAccountAuthority = (0, util_1.findBSolTokenAccountAuthority)(config)[0];
    const bsolAssociatedTokenAddress = yield anchor_1.utils.token.associatedAddress({
        mint: blaze.bsolMint,
    ...
    const newProvider = new marinade_ts_sdk_1.Provider(provider.connection, provider.wallet, {});
    const stakeAccountInfo = yield marinade_ts_sdk_1.MarinadeUtils.getParsedStakeAccountInfo(newProvider, stakeAccount);
...
const blazeWithdrawSol = (config, program, blaze, user, userGsolTokenAccount, amount) => __awaiter(void 0, void 0, void 0, function* () {
    const [gsolMintAuthority] = (0, util_1.findGSolMintAuthority)(config);
    const bsolTokenAccountAuthority = (0, util_1.findBSolTokenAccountAuthority)(config)[0];
    const bsolAssociatedTokenAddress = yield anchor_1.utils.token.associatedAddress({
        mint: blaze.bsolMint,
...
const blazeWithdrawStake = (config, program, blaze, newStakeAccount, user, userGsolTokenAccount, amount) => __awaiter(void 0, void 0, void 0, function* () {
    const [gsolMintAuthority] = (0, util_1.findGSolMintAuthority)(config);
    const bsolTokenAccountAuthority = (0, util_1.findBSolTokenAccountAuthority)(config)[0];
    const bsolAssociatedTokenAddress = yield anchor_1.utils.token.associatedAddress({
        mint: blaze.bsolMint,
