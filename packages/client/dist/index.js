...
exports.SunriseStakeClient = exports.getStakePoolAccount = void 0;
...
Object.defineProperty(exports, "getStakePoolAccount", { enumerable: true, get: function () { return decode_stake_pool_1.getStakePoolAccount; } });
// export all types
...
class SunriseStakeClient {
    constructor(provider, stateAddress, options = {}) {
        ...
        this.getRegisterStateAccounts = (treasury, gsolMint, options = {}
        // TODO get these types from the IDL
            ...
            const marinadeState = yield new marinade_ts_sdk_1.Marinade(marinadeConfig).getMarinadeState();
            const [, gsolMintAuthorityBump] = (0, util_1.findGSolMintAuthority)(config);
            const [msolAuthority, msolAuthorityBump] = (0, util_1.findMSolTokenAccountAuthority)(config);
            ...
            const [bsolAuthority, bsolAuthorityBump] = (0, util_1.findBSolTokenAccountAuthority)(config);
            const bsolTokenAccountAddress = yield anchor_1.utils.token.associatedAddress({
        ...
        this.program = new anchor_1.Program(SunriseStake_1.IDL, util_1.PROGRAM_ID, provider);
        this.staker = this.provider.publicKey;
    }
    log(...args) {
        var _a;
        Boolean((_a = this.config) === null || _a === void 0 ? void 0 : _a.options.verbose) && console.log(...args);
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            const sunriseStakeState = yield this.program.account.state.fetch(this.stateAddress);
            const stakePoolInfo = yield (0, decode_stake_pool_1.getStakePoolAccount)(this.provider.connection, constants_1.SOLBLAZE_CONFIG.pool);
            this.config = {
            ...
            const [gsolMintAuthority] = (0, util_1.findGSolMintAuthority)(this.config);
            this.msolTokenAccountAuthority = (0, util_1.findMSolTokenAccountAuthority)(this.config)[0];
            this.bsolTokenAccountAuthority = (0, util_1.findBSolTokenAccountAuthority)(this.config)[0];
            const marinadeConfig = new marinade_ts_sdk_1.MarinadeConfig({
                connection: this.provider.connection,
            ...
            const [withdrawAuthority] = web3_js_1.PublicKey.findProgramAddressSync([constants_1.SOLBLAZE_CONFIG.pool.toBuffer(), Buffer.from("withdraw")], constants_1.STAKE_POOL_PROGRAM_ID);
            const [depositAuthority] = web3_js_1.PublicKey.findProgramAddressSync([constants_1.SOLBLAZE_CONFIG.pool.toBuffer(), Buffer.from("deposit")], constants_1.STAKE_POOL_PROGRAM_ID);
            this.blazeState = {
    ...
    createGSolTokenAccountIx() {
        ...
        const createATAInstruction = (0, spl_token_1.createAssociatedTokenAccountIdempotentInstruction)(this.provider.publicKey, this.stakerGSolTokenAccount, this.staker, this.config.gsolMint);
    ...
    deposit(lamports) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.marinadeState ||
                ...
                throw new Error("init not called");
            const gsolTokenAccount = yield this.provider.connection.getAccountInfo(this.stakerGSolTokenAccount);
            const transaction = new web3_js_1.Transaction();
            if (!gsolTokenAccount) {
                const createUserTokenAccount = yield this.createGSolTokenAccountIx();
                transaction.add(createUserTokenAccount);
            }
            const depositTx = yield (0, marinade_1.deposit)(this.config, this.program, this.marinade, this.marinadeState, this.config.stateAddress, this.provider.publicKey, this.stakerGSolTokenAccount, lamports);
    ...
    depositToBlaze(lamports) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depositTx = yield (0, blaze_1.blazeDeposit)(this.config, this.program, this.blazeState, this.provider.publicKey, this.stakerGSolTokenAccount, lamports);
            transaction.add(depositTx);
            return this.sendAndConfirmTransaction(transaction, []);
        });
    }
    depositStakeToBlaze(stakeAccountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depositTx = yield (0, blaze_1.blazeDepositStake)(this.config, this.program, this.provider, this.blazeState, this.provider.publicKey, stakeAccountAddress, this.stakerGSolTokenAccount);
            transaction.add(depositTx);
            return this.sendAndConfirmTransaction(transaction, []);
        });
    }
    depositStakeAccount(stakeAccountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depositStakeIx = yield (0, marinade_1.depositStakeAccount)(this.config, this.program, this.marinade, this.marinadeState, this.provider.publicKey, stakeAccountAddress, this.stakerGSolTokenAccount);
    ...
    unstake(lamports) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.marinadeState ||
                ...
                !this.stakerGSolTokenAccount)
                throw new Error("init not called");
            const transaction = yield (0, marinade_1.liquidUnstake)(this.config, this.marinade, this.marinadeState, this.program, this.stateAddress, this.staker, this.stakerGSolTokenAccount, lamports);
            Boolean((_a = this.config) === null || _a === void 0 ? void 0 : _a.options.verbose) && (0, util_1.logKeys)(transaction);
            return this.sendAndConfirmTransaction(transaction, []);
        });
    }
    /**
    ...
    triggerRebalance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.marinadeState ||
                ...
                !this.stakerGSolTokenAccount)
                throw new Error("init not called");
            const { instruction } = yield (0, marinade_1.triggerRebalance)(this.config, this.marinade, this.marinadeState, this.program, this.stateAddress, this.provider.publicKey);
    ...
    orderUnstake(lamports) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.marinadeState ||
                ...
                !this.msolTokenAccount)
                throw new Error("init not called");
            const { transaction, newTicketAccount, proxyTicketAccount } = yield this.marinade.orderUnstake(lamports, this.msolTokenAccount);
            Boolean((_a = this.config) === null || _a === void 0 ? void 0 : _a.options.verbose) && (0, util_1.logKeys)(transaction);
    ...
    toTicketAccount(sunriseTicketAccount, address) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const marinadeTicketAccount = yield ((_a = this.marinade) === null || _a === void 0 ? void 0 : _a.getDelayedUnstakeTicket(sunriseTicketAccount.marinadeTicketAccount));
            if (!marinadeTicketAccount)
                throw new Error(`Marinade ticket with address ${sunriseTicketAccount.marinadeTicketAccount.toString()} not found`);
            return Object.assign(Object.assign({ address }, sunriseTicketAccount), marinadeTicketAccount);
        });
    }
    getDelayedUnstakeTickets() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ticketAccounts = yield this.program.account.sunriseTicketAccount.all([
                {
                    memcmp: {
                        offset: 8 + 32 + 32,
            ...
            const resolvedTicketAccountPromises = ticketAccounts.map(({ account, publicKey }) => __awaiter(this, void 0, void 0, function* () { return this.toTicketAccount(account, publicKey); }));
    ...
    claimUnstakeTicketFromAddress(ticketAccountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.marinade || !this.marinadeState)
                throw new Error("init not called");
            const sunriseTicketAccount = yield this.program.account.sunriseTicketAccount.fetch(ticketAccountAddress);
            const account = yield this.toTicketAccount(sunriseTicketAccount, ticketAccountAddress);
    ...
    withdrawFromBlaze(amount) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.blazeState ||
                ...
                throw new Error("init not called");
            const withdrawIx = yield (0, blaze_1.blazeWithdrawSol)(this.config, this.program, this.blazeState, this.provider.publicKey, this.stakerGSolTokenAccount, amount);
    ...
    withdrawStakeFromBlaze(newStakeAccount, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.blazeState ||
                ...
                !this.bsolTokenAccount)
                throw new Error("init not called");
            const withdrawStakeIx = yield (0, blaze_1.blazeWithdrawStake)(this.config, this.program, this.blazeState, newStakeAccount, this.provider.publicKey, this.stakerGSolTokenAccount, amount);
    ...
    calculateWithdrawalFee(withdrawalLamports, details) {
        ...
        const preferredMinLiqPoolValue = new bn_js_1.default(details.balances.gsolSupply.amount).muln(0.1);
        const postUnstakeLpSolValue = new bn_js_1.default(lpSolShare).sub(withdrawalLamports);
        ...
        const amountToOrderUnstake = new bn_js_1.default(preferredMinLiqPoolValue).sub(postUnstakeLpSolValue);
        ...
        if (amountBeingLiquidUnstaked.lte(util_1.ZERO))
            return util_1.ZERO;
        // Calculate the fee
    ...
    details() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lpMsolBalancePromise = this.provider.connection.getTokenAccountBalance(this.marinadeState.mSolLeg);
            ...
            const [epochInfo, lpMintInfo, lpSolLegBalance, lpMsolBalance, balances] = yield Promise.all([
                epochInfoPromise,
                lpMintInfoPromise,
            ...
            const availableLiqPoolSolLegBalance = new bn_js_1.default(lpSolLegBalance).sub(this.marinadeState.state.rentExemptForTokenAcc);
            const lpMsolShare = (0, util_1.proportionalBN)(new bn_js_1.default(balances.liqPoolBalance.amount), new bn_js_1.default(lpMsolBalance.value.amount), new bn_js_1.default(lpMintInfo.supply.toString()));
            const lpSolShare = (0, util_1.proportionalBN)(new bn_js_1.default(balances.liqPoolBalance.amount), availableLiqPoolSolLegBalance, new bn_js_1.default(lpMintInfo.supply.toString()));
            const solValueOlpMSolShare = this.computeLamportsFromMSol(lpMsolShare, this.marinadeState);
            const lpSolValue = lpSolShare.add(solValueOlpMSolShare);
            const solValueOfMSol = this.computeLamportsFromMSol(new bn_js_1.default(balances.msolBalance.amount), this.marinadeState);
            const mpDetails = {
            ...
            const lpDetails = {
                ...
                mintAuthority: (_a = lpMintInfo.mintAuthority) === null || _a === void 0 ? void 0 : _a.toBase58(),
            ...
            const inflight = yield Promise.all([epochInfo.epoch, epochInfo.epoch - 1].map((epoch) => __awaiter(this, void 0, void 0, function* () {
                return (0, marinade_1.orders)(config, this.program, BigInt(epoch)).then(({ managementAccount, tickets }) => {
                    var _a, _b;
                    return ({
                        epoch: BigInt(epoch),
                        tickets: tickets.length,
                        totalOrderedLamports: (_b = (_a = managementAccount.account) === null || _a === void 0 ? void 0 : _a.totalOrderedLamports) !== null && _b !== void 0 ? _b : util_1.ZERO,
                    });
                });
            })));
            const stakePoolInfo = yield (0, decode_stake_pool_1.getStakePoolAccount)(this.provider.connection, constants_1.SOLBLAZE_CONFIG.pool);
            const [bsolPrice, bsolValue] = this.computeLamportsFromBSol(new bn_js_1.default(balances.bsolBalance.amount), stakePoolInfo);
            const bpDetails = {
            ...
            const detailsWithoutYield = {
                ...
                sunriseStakeConfig: {
                    ...
                    msolTokenAccountAuthority: (_b = this.msolTokenAccountAuthority) === null || _b === void 0 ? void 0 : _b.toBase58(),
                },
            ...
            const extractableYield = this.calculateExtractableYield(detailsWithoutYield);
            return Object.assign(Object.assign({}, detailsWithoutYield), { extractableYield });
        });
    }
    computeLamportsFromMSol(msolAmount, marinadeState) {
        const totalCoolingDown = marinadeState.state.stakeSystem.delayedUnstakeCoolingDown.add(marinadeState.state.emergencyCoolingDown);
        const totalLamportsUnderControl = marinadeState.state.validatorSystem.totalActiveBalance
            .add(totalCoolingDown)
            .add(marinadeState.state.availableReserveBalance);
        const totalVirtualStakedLamports = totalLamportsUnderControl.sub(marinadeState.state.circulatingTicketBalance);
        return (0, util_1.proportionalBN)(msolAmount, totalVirtualStakedLamports, marinadeState.state.msolSupply);
    }
    computeLamportsFromBSol(bsolAmount, stakePoolInfo) {
        const bsolPrice = Number(stakePoolInfo.totalLamports) /
    ...
    calculateExtractableYield({ epochInfo, balances, mpDetails, lpDetails, inflight, bpDetails, }) {
        ...
        const inflightTotal = inflight.reduce((acc, { totalOrderedLamports }) => acc.add(totalOrderedLamports), util_1.ZERO);
    ...
    static register(treasury, gsolMint, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const client = new SunriseStakeClient((0, util_1.setUpAnchor)(), sunriseStakeState.publicKey, options);
            const { accounts, parameters } = yield client.getRegisterStateAccounts(treasury, gsolMint.publicKey, options);
    ...
    update({ newTreasury, newUpdateAuthority, newliqPoolProportion, newliqPoolMinProportion, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.config)
                throw new Error("init not called");
            const { accounts, parameters } = yield this.getRegisterStateAccounts(newTreasury !== null && newTreasury !== void 0 ? newTreasury : this.config.treasury, this.config.gsolMint);
            yield this.program.methods
                .updateState(Object.assign(Object.assign({}, parameters), { updateAuthority: newUpdateAuthority !== null && newUpdateAuthority !== void 0 ? newUpdateAuthority : parameters.updateAuthority, liqPoolProportion: newliqPoolProportion !== null && newliqPoolProportion !== void 0 ? newliqPoolProportion : parameters.liqPoolProportion, liqPoolMinProportion: newliqPoolMinProportion !== null && newliqPoolMinProportion !== void 0 ? newliqPoolMinProportion : parameters.liqPoolMinProportion }))
                .accounts(accounts)
                .rpc()
    ...
    balance() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gsolSupplyPromise = this.provider.connection.getTokenSupply(this.config.gsolMint);
            const msolTokenAccountAuthority = (0, util_1.findMSolTokenAccountAuthority)(this.config)[0];
            const msolAssociatedTokenAccountAddress = yield anchor_1.utils.token.associatedAddress({
                mint: this.marinadeState.mSolMintAddress,
            ...
            const bsolTokenAccountAuthority = (0, util_1.findBSolTokenAccountAuthority)(this.config)[0];
            const bsolAssociatedTokenAccountAddress = yield anchor_1.utils.token.associatedAddress({
                mint: constants_1.SOLBLAZE_CONFIG.bsolMint,
                owner: bsolTokenAccountAuthority,
            });
            const bsolLamportsBalancePromise = this.provider.connection.getTokenAccountBalance(bsolAssociatedTokenAccountAddress);
            // use the same token authority PDA for the msol token account
            // and the liquidity pool token account for convenience
            const liqPoolAssociatedTokenAccountAddress = yield anchor_1.utils.token.associatedAddress({
                mint: this.marinadeState.lpMint.address,
            ...
            const liqPoolBalancePromise = this.provider.connection.getTokenAccountBalance(liqPoolAssociatedTokenAccountAddress);
            const treasuryBalancePromise = this.provider.connection.getBalance(this.config.treasury);
            const [gsolBalance, gsolSupply, msolLamportsBalance, lpBalance, treasuryBalance, bsolLamportsBalance,] = yield Promise.all([
                gsolBalancePromise,
                gsolSupplyPromise,
